$(document).ready(function(){
	...
	var backtwo = ["red", "yellow", "green"];
	var risd = ["Michael&nbsp;", "Rock&nbsp;", "Rhode&nbsp;", "Island&nbsp;", "School&nbsp;", "of Design&nbsp;", "Visiting&nbsp;", "Designer&nbsp;", "February&nbsp;", "25&nbsp;", "6:30pm&nbsp;", "<img src='Michael.png'>&nbsp;", "<img src='rock.png'>&nbsp;"];
